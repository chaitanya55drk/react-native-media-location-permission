...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  RNAccessMediaLocationPermission is used to enable the media location permission
                   DESC
  s.homepage     = "https://github.com/chaithanya8888/react-native-media-location-permission"
  s.license      = "MIT"
  # s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  s.author             = { "Venkata Chaithanya" => "vchaitanya@travogram.com" }
  s.platform     = :ios, "10.0"
  s.source       = { :git => "https://github.com/chaithanya8888/react-native-media-location-permission.git", :tag => "master" }
